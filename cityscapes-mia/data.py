...
class CityscapesDataset:
    def __init__(self, train_size):
        ...
        self.victim_val_paths = {'imgs': victim_data['imgs'][train_size:train_size+200], 'lbls': victim_data['lbls'][train_size:train_size+200]}

        self.shadow_train_paths = {'imgs': shadow_data['imgs'][:train_size], 'lbls': shadow_data['lbls'][:train_size]}
        self.shadow_val_paths = {'imgs': shadow_data['imgs'][train_size:train_size+200], 'lbls': shadow_data['lbls'][train_size:train_size+200]}

        # making datasets for training the attack model
        # hardcoded for 400 samples (200/200 in/out split)
