...
def get_victim(data, args):
    ...
    # knowledge distillation
        ...
        unprotected_model, _, threshold = train_segmentation_model(
            args.victim, victim_train_dataloader, victim_val_dataloader, SEG_EPOCHS, SEG_LR, return_val_loss=True,
        )
