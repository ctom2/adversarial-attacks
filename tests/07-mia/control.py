from models import *
# from data import *
from data_liver import *
from attack import *

class MIAattack:
    def __init__(self, segmentation_batch_size=4, attack_batch_size=4, dp=False):
        ...
        self.data = MIAdata(segmentation_batch_size=segmentation_batch_size, attack_batch_size=attack_batch_size)

    def train_victim_model(self, lr=2e-3, epochs=10, noise_multiplier=1.0, max_grad_norm=1.0):
    ...
    def train_shadow_model(self, lr=2e-3, epochs=10, noise_multiplier=1.0, max_grad_norm=1.0):
