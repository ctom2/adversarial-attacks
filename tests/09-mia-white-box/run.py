...
SEG_BATCH_SIZE=16
VICTIM_TRAIN_EPOCHS=1

SHADOW_TRAIN_EPOCHS=1

ATTACK_BATCH_SIZE=4
ATTACK_TRAIN_EPOCHS=30
ATTACK_INPUT_CHANNELS=96 # 2 for 2-channel attack
...
victim_model = train_segmentation_model(victim_model, victim_train_dataloader, lr=1e-4, epochs=VICTIM_TRAIN_EPOCHS)
...
shadow_model = train_segmentation_model(shadow_model, shadow_train_dataloader, lr=1e-4, epochs=SHADOW_TRAIN_EPOCHS)
