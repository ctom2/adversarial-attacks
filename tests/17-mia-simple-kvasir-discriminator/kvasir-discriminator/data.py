...
class KvasirDataset:
    def __init__(self):
        ...
        victim_paths, shadow_paths = victim_shadow_split(kvasir_paths)
        ...
        print('Attack model train paths:', len(self.shadow_attack_paths['imgs']))
        print('Attack model test paths:', len(self.victim_attack_paths['imgs']))
        print('************************')
